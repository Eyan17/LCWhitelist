...
namespace LethalCompanyTemplate
{
    ...
    internal class Whitelist : BaseUnityPlugin
    {
        ...
        public static bool hasSubscribed = false;
    ...
    internal class HarmonyUpdatePatch
    {
        ...
        {
            if (!Whitelist.hasSubscribed && NetworkManager.Singleton != null)
            {
                NetworkManager.Singleton.OnClientConnectedCallback += Whitelist.OnClientConnect;
                Whitelist.hasSubscribed = true;
            }
